 ...
 */
public class Logistic_1_1_1_FeedForwardGradientChecker {
    ...
    private static DataSet createDataSet() {
        try {
            ...
            Logger.getLogger(Logistic_1_1_1_FeedForwardGradientChecker.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
