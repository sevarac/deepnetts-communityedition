...
//                                  octave: 0.042102          0.353884         0.105654         0.240516         0.173893         0.335430         0.164394        -0.335289         0.091407          -0.015246
    ...
    */
    ...
    public void testForward2DInputSingleOutput() {
        ...
        // create instance of layer to test
        FullyConnectedLayer instance = new FullyConnectedLayer(1, ActivationType.LINEAR);
        instance.setPrevLayer(prevLayer);
        instance.init(); // init weights structure
        ...
        RandomWeights.uniform(weights.getValues(), 12); // [-0.02413708, -0.25080326, -0.23727596, -0.24853897, -0.21809235, -0.2362793, -0.09346612, -0.043609187, 0.24941927, 0.21615475, 0.102702856, 0.043361217]
    ...
    public void testForward2DInputTwoOutputs() {
        ...
        // create instance of layer to test
        FullyConnectedLayer instance = new FullyConnectedLayer(2, ActivationType.LINEAR);
        instance.setPrevLayer(prevLayer);
        instance.init(); // init weights structure
    ...
    public void testForward3DInputSingleOutput() {
        ...
        RandomWeights.uniform(weights.getValues(), 24); // [-0.108392015, -0.11781825, -0.009438843, 0.04662688, -0.14611204, -0.19046502, -0.024704024, 0.077116504, -0.1583929, 0.07516374, 0.14243786, -0.17339982, -0.14016245, 0.18240763, -0.040653482, -0.025770023, 0.17933364, 0.07912485, -0.034144267, 0.07201438, 0.13413312, 0.052575663, 0.06653626, 0.03049782]
    ...
    public void testBackwardLinear() {
        ...
        RandomWeights.uniform(weights2.getValues(), 5); // [0.19961303, -0.23501621, 0.43907326, -0.17747784, -0.22066136, 0.06630343, 0.097314, -0.21566293, 0.273578, 0.10945064, 0.33577937, 0.044093937, 0.19323963, -0.3021235, -0.38288906, 0.16261822, 0.26498383, -0.207817, 0.070406556, -0.23022851, 0.36503863, 0.091478825, -0.31402034, -0.25345784, 0.42504954, -0.037393004, -0.38854277, -0.36758634, -0.38503492, -0.33786723, -0.36604232, -0.14479709, -0.06755906, 0.38639867, 0.3348655, 0.15910655, 0.06717491, -0.4455302, -0.09257606, -1.219213E-4, -0.21616945, 0.43006968, -0.31055218, 0.2699433, -0.214278, 0.25471163, -0.03427276, -0.43431506, -0.054469943, -0.23747501]

        Tensor weights1 = new Tensor(5, 5);
        RandomWeights.uniform(weights1.getValues(), 5);    // [-0.25812685, -0.020679474, 0.102154374, -0.32011545, -0.41728795, -0.05412379, 0.16895384, -0.3470215, 0.16467547, 0.31206572, -0.37989998, -0.30708057, 0.39963514, -0.08906731, -0.056459278, 0.39290035, 0.17335385, -0.07480636, 0.15777558, 0.29387093, 0.115187526, 0.14577365, 0.0668174, -0.4196531, -0.10020122]
        ...
        FullyConnectedLayer prevLayer = new FullyConnectedLayer(5); // feeds input into tested layer
...
/*
    ...
    /**
     * Double checked with octave 30.1.19.
     */
    @Test
    public void testBackward2DInputSingleOutput() {
        // initialize weights with specified random seed
        RandomGenerator.getDefault().initSeed(123); // init random generator with seed that will be used for weights2 (same effect as line above)

        // input vector for this layer  width:4, height:3
        Tensor input = Tensors.random(4, 5);    // random input matrix [0.72317415, 0.23724389, 0.99089885, 0.30157375; 0.2532931, 0.57412946, 0.60880035, 0.2588815; 0.80586946, 0.6223695, 0.87541276, 0.5492985; 0.7160485, 0.16221565, 0.071917, 0.6818127; 0.79626095, 0.26765352, 0.57871693, 0.24259669]

        // create prev fc layer with 5 outputs
        InputLayer inputLayer = new InputLayer(5, 4);
        ...
        RandomWeights.uniform(weights.getValues(), 20); // [-0.02413708, -0.25080326, -0.23727596, -0.24853897, -0.21809235, -0.2362793, -0.09346612, -0.043609187, 0.24941927, 0.21615475, 0.102702856, 0.043361217]
        ...
        prevConvLayer.forward();
        instance.forward(); // mora forward da bi povukao inpute
        instance.backward();
     ...
     */
   @Test
    public void testBackward2DInputTwoOutputs() {
        // initialize weights with specified random seed
        RandomGenerator.getDefault().initSeed(123); // init random generator with seed that will be used for weights2 (same effect as line above)
        ...
        // weights for dense layer: prevLayer.width, prevLayer.height, prevLayer.depth, width
        Tensor weights = new Tensor(5, 4, 1, 2); // weights matrix
        RandomWeights.uniform(weights.getValues(), 40); // [-0.02413708, -0.25080326, -0.23727596, -0.24853897, -0.21809235, -0.2362793, -0.09346612, -0.043609187, 0.24941927, 0.21615475, 0.102702856, 0.043361217]
   ...
   @Test
    public void testBackward3DInputSingleOutput() {
        ...
        prevConvLayer.forward();    // ovaj baca exception!!!
        instance.forward(); // mora forward da bi povukao inpute
        instance.backward();
    ...
    public void testBackward3DInputTwoOutputs() {
        ...
        RandomWeights.uniform(weights.getValues(), 80); // [-0.02413708, -0.25080326, -0.23727596, -0.24853897, -0.21809235, -0.2362793, -0.09346612, -0.043609187, 0.24941927, 0.21615475, 0.102702856, 0.043361217]
    ...
    public void testApplyWeightChanges() {
        ...
        Tensor weights = new Tensor(5, 10);
        RandomWeights.initSeed(123);

        Tensor biases = new Tensor(10); //  ? zasto ovde isod opet randomize kad gore imam uniform
        RandomWeights.uniform(weights.getValues(), 5); //  0.19961303, -0.23501621, 0.43907326, -0.17747784, -0.22066136, 0.06630343, 0.097314, -0.21566293, 0.273578, 0.10945064, 0.33577937, 0.044093937, 0.19323963, -0.3021235, -0.38288906, 0.16261822, 0.26498383, -0.207817, 0.070406556, -0.23022851, 0.36503863, 0.091478825, -0.31402034, -0.25345784, 0.42504954, -0.037393004, -0.38854277, -0.36758634, -0.38503492, -0.33786723, -0.36604232, -0.14479709, -0.06755906, 0.38639867, 0.3348655, 0.15910655, 0.06717491, -0.4455302, -0.09257606, -1.219213E-4, -0.21616945, 0.43006968, -0.31055218, 0.2699433, -0.214278, 0.25471163, -0.03427276, -0.43431506, -0.054469943, -0.23747501
        RandomWeights.randomize(biases.getValues()); // "[-0.2885946, -0.023120344, 0.114212096, -0.35789996, -0.46654212, -0.060512245, 0.18889612, -0.38798183, 0.18411279, 0.34890008]"
