...
//    String trainingFile = "datasets/mnist/train.txt";
    ...
    public void run() throws DeepNettsException, IOException {
        ...
        imageSet.loadImages(new File(trainingFile), false, 40000);
        imageSet.invert();
        imageSet.zeroMean();
        imageSet.shuffle();
        ...
        ConvolutionalNetwork neuralNet = (ConvolutionalNetwork)FileIO.createFromJson(new File("mnistDemo.json"));
        ...
        BackpropagationTrainer trainer = new BackpropagationTrainer(neuralNet); // send props as a param to set all peoperties from properties file
